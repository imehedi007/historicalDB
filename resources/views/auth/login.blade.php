                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                <a class="text-center" href="index.html"> <h4>Welcome Back!</h4></a>
                                <form class="mt-5 mb-5 login-input" action="{{ route('login') }}" method="POST">
                                    ...
                                    <p class="mt-5 login-form__footer">Dont have account? <a href="../registration/registration.php" class="text-primary">Sign Up </a> now</p>
                                    </p>
                                </div>
                            </div>
                        </div>
