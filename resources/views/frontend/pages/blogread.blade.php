    ...
    <div class="container-xl">
        ...
        {{-- <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Ipsam, eos!</li>
            </ol>
        </nav> --}}
            ...
            <div class="col-lg-8">
                ...
                <div class="post post-single">
                    ...
                    <div class="post-header">
                        <h1 class="title mt-0 mb-3">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quos, excepturi.</h1>
                ...
                <div class="about-author padding-30 rounded">
                    <div class="thumb">
                        <img src="images/other/avatar-about.png" alt="Database" />
                    </div>
                    <div class="details">
                        <h4 class="name"><a href="#">Database</a></h4>
                        ...
                        <div class="widget-content">
                            ...
                            <div class="post post-list-sm circle">
                                ...
                                <div class="details clearfix">
                                    <h6 class="post-title my-0"><a href="blog-single.html">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Tempore, quibusdam!</a></h6>
                            ...
                            <div class="post post-list-sm circle">
                                ...
                                <div class="details clearfix">
                                    <h6 class="post-title my-0"><a href="blog-single.html">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ratione, similique?</a></h6>
                                    <ul class="meta list-inline mt-1 mb-0">
                                        <li class="list-inline-item">29 March 2021</li>
                                    </ul>
                                </div>
                            ...
                            <div class="post post-list-sm circle">
                                ...
                                <div class="details clearfix">
                                    <h6 class="post-title my-0"><a href="blog-single.html">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Voluptatum, veritatis.</a></h6>
                                    <ul class="meta list-inline mt-1 mb-0">
                                        <li class="list-inline-item">29 March 2021</li>
                                    </ul>
                                </div>
